...
def make_payload(page,data):

	model = '''POST /{0} HTTP/1.1/*diego*/Host: 127.0.0.1:8888/*diego*/User-Agent: curl/7.68.0/*diego*/Accept: */*/*diego*/Content-Type: application/x-www-form-urlencoded/*diego*/Content-Length: {1}/*diego*//*diego*/{2}'''
	length = len(data)
...
if __name__ == '__main__':
	...
	if args.data == None  :
		print("usage: index.py [-h] [-p page] [-d data]")
	else:
		make_payload(args.page,args.data)
```
